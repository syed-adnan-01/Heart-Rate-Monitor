...
const slides = [
  ...
  },
  {
    ...
    icon: <DollarSign className="w-16 h-16 text-emerald-400" />,
      ...
      <div className="w-full max-w-4xl aspect-video bg-slate-900 rounded-3xl border border-slate-800 overflow-hidden relative shadow-2xl shadow-cyan-500/10">
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <h2 className="text-6xl font-bold text-white mb-4 tracking-tight">{slides[current].title}</h2>
            <h3 className="text-3xl text-cyan-400 font-medium mb-8">{slides[current].subtitle}</h3>
        ...
        <div className="absolute bottom-8 left-0 right-0 flex items-center justify-between px-12">
          ...
          <div className="flex gap-4">
            ...
            <button
              ...
              onClick={() => setCurrent(c => c + 1)}
              className="p-3 rounded-full bg-cyan-500 text-white disabled:opacity-30 hover:bg-cyan-600 transition-colors"
            >
